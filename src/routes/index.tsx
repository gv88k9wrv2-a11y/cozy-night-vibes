  ...
  head: () => ({
    meta: [
      { title: "נמרודי ושות׳ – רואי חשבון בהרצליה | ליווי חברות, סטארטאפים ועצמאים" },
      {
        name: "description",
        content:
          "משרד רואי חשבון בוטיק בהרצליה פיתוח. מעל 25 שנות ניסיון בליווי חברות, סטארטאפים, עצמאים ופרילנסרים – ביקורת, דיווח, ייעוץ מס וגיוסי הון. פגישת ייעוץ ראשונה ללא התחייבות.",
      },

...
const FAQS = [
  ...
  { q: "What is Section 102 (Equity & ESOP Incentive Plans) and how does it work?", a: "Section 102 (Equity & ESOP Incentive Plans) lets Israeli companies grant equity to employees under the capital gains track (25% tax) via a trustee. We prepare and file the plan, appoint and work with the trustee, and support employees at exercise and sale." },
